...
import TextToAudioService from '../services/text-to-audio-service.js';
...
const textToAudioService = new TextToAudioService({ sdk: new TextToSpeechClient() });

const messageController = new MessageController(messageService, audioToTextService, textToAudioService, validatorService);
